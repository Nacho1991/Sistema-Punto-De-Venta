...
{
    public class AccesoDatosPostgre : AccesoDatos
    {
        ...
        // Constructor
        public AccesoDatosPostgre(string ConnectionString)
        {
            limpiarEstado();
        ...
        public override Boolean estado()
        {
            ...
            switch (conexion.State)
            {
                case System.Data.ConnectionState.Broken:
                    mensaje = "Error-0010|| ||La conexión con la base de datos fue interrumpida.";
                    break;
                case System.Data.ConnectionState.Closed:
                    mensaje = "Error-0011|| ||La conexión con la base de datos fue cerrada o no pudo ser establecida.";
                    break;
                case System.Data.ConnectionState.Connecting:
                    mensaje = "Error-0012|| ||Conectandose.";
                    break;
                case System.Data.ConnectionState.Executing:
                    mensaje = "Error-0013|| ||Ejecutando.";
                    break;
                case System.Data.ConnectionState.Fetching:
                    mensaje = "Error-0014|| ||Extrayendo.";
                    break;
                case System.Data.ConnectionState.Open:
                    mensaje = "Error-0015|| ||Abierta.";
                    break;
            }
        ...
        private void ProcesarExcepcion(NpgsqlException pExcepcion)
        {
            IsError = true;
            ErrorDescripcion += " \n" + pExcepcion.Message + " \n";
